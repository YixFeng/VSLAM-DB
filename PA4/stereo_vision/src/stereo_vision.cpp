...
string prefix= "/home/fengyixiao/Dark_Blue/SLAM/course/Complete/PA4/stereo_vision";
string left_file = prefix + "/left.png";
string right_file = prefix + "/right.png";
string disparity_file = prefix + "/disparity.png";
    ...
    for (int v = 0; v < left.rows; v++)
        for (int u = 0; u < left.cols; u++) {
            ...
            */
            ...
            // 前三维为xyz,第四维为颜色;有一个RGB_D的点云(在slambook2上),那个是六维因为三个维度的颜色
